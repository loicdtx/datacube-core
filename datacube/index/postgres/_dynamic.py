...
from datacube.index.postgres._core import schema_qualified
from datacube.index.postgres._schema import DATASET, DATASET_TYPE, METADATA_TYPE
from datacube.index.postgres._sql import _pg_exists, CreateView
...
def _check_field_index(conn, fields, name_prefix, filter_expression,
    ...
    exists = _pg_exists(conn, schema_qualified(index_name))
    legacy_exists = _pg_exists(conn, schema_qualified(legacy_name))
