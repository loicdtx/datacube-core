...
def get_s3_url_http(bucket_name, obj_key):
    endpoint= '.s3-us-west-2.amazonaws.com'
    return 'http://{bucket_name}{end_point}/{obj_key}'.format(
        bucket_name=bucket_name, end_point=endpoint,
        obj_key=obj_key)
...
def add_datacube_dataset(bucket_name,config):
    ...
    for metadata_path,metadata_doc in get_metadata_docs(bucket_name):
        uri= get_s3_url_http(bucket_name, metadata_path)
